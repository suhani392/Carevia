...
export const translations = {
    en: {
        ...
        enter_email_error: "Please enter your email to reset password.",
    ...
    mr: {
        ...
        forgot_password_success: "पासवर्ड रीसेट ईमेल पाठवले गेले आहे. कृपया इनबॉक्स तपासा.",
        enter_email_error: "पासवर्ड रीसेट करण्यासाठी कृपया तुमचा ईमेल प्रविष्ट करा.",
        reset_password_error: "रीसेट ईमेल पाठवण्यात त्रुटी आली.",
    ...
    hi: {
        ...
        forgot_password_success: "पासवर्ड रीसेट ईमेल भेज दिया गया है। कृपया इनबॉक्स जांचें।",
        enter_email_error: "पासवर्ड रीसेट करने के लिए कृपया अपना ईमेल ईमेल दर्ज करें।",
        reset_password_error: "रीसेट ईमेल भेजने में त्रुटि हुई।",
    ...
    kn: {
        ...
        forgot_password_success: "ಪಾಸ್‌ವರ್ಡ್ ಮರುಹೊಂದಿಸುವ ಇಮೇಲ್ ಕಳುಹಿಸಲಾಗಿದೆ. ದಯವಿಟ್ಟು ನಿಮ್ಮ ಇನ್‌ಬಾಕ್ಸ್ ಪರಿಶೀಲಿಸಿ.",
        enter_email_error: "ಪಾಸ್‌ವರ್ಡ್ ಮರುಹೊಂದಿಸಲು ದಯವಿಟ್ಟು ನಿಮ್ಮ ಇಮೇಲ್ ನಮૂದಿಸಿ.",
        reset_password_error: "ಮರುಹೊಂದಿಸುವ ಇಮೇಲ್ ಕಳುಹಿಸುವಲ್ಲಿ ದೋಷ ಉಂಟಾಗಿದೆ.",
    ...
    pa: {
        ...
        forgot_password_success: "ਪਾਸਵਰਡ ਰੀਸੈਟ ਈਮੇਲ ਭੇਜ ਦਿੱਤੀ ਗਈ ਹੈ। ਕਿਰਪਾ ਕਰਕੇ ਆਪਣਾ ਇਨਬਾਕਸ ਚੈੱਕ ਕਰੋ।",
        enter_email_error: "ਪਾਸਵਰਡ ਰੀਸੈਟ ਕਰਨ ਲਈ ਕਿਰਪਾ ਕਰકે ਆਪਣੀ ਈਮੇਲ ਦਰਜ ਕਰੋ।",
        reset_password_error: "ਰੀਸੈਟ ਈਮੇਲ ਭੇਜਣ ਵਿੱਚ ਗਲਤੀ ਆਈ ਹੈ।",
    ...
    ta: {
        ...
        forgot_password_success: "கடவுச்சொல் மீட்டமைப்பு மின்னஞ்சல் அனுப்பப்பட்டது. உங்கள் இன்பாக்ஸைச் சரிபார்க்கவும்.",
        enter_email_error: "கடவுச்சொல்லை மீட்டமைக்க உங்கள் மின்னஞ்சலை உள்ளிடவும்.",
        reset_password_error: "மீட்டமைப்பு மின்னஞ்சலை அனுப்புவதில் பிழை.",
    ...
    gu: {
        ...
        forgot_password_success: "પાસવર્ડ રીસેટ ઇમેઇલ મોકલવામાં આવ્યું છે. કૃપા કરીને તમારું ઇનબોક્સ તપાસો.",
        enter_email_error: "પાસવર્ડ રીસેટ કરવા માટે કૃપા કરીને તમારું ઇમેઇલ દાખલ કરો.",
        reset_password_error: "રીસેટ ઇમેઇલ મોકલવામાં ભૂલ આવી છે.",
